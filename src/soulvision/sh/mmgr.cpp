...
//		#include <streamio>  //
//
//		#include "myfile1.h" // Project includes MUST come next
//		#include "myfile2.h" //
//		#include "myfile3.h" //
//
//		#include "mmgr.h"    // mmgr.h MUST come last
//
//    Note that normally with MMGR, mmgr.h is included in between the standard and project includes. However, with this project it
//    is not possible to always have that include structure, so instead mmgr.h is included at the end, and strict care is taken not
//    to use any allocation functions in header files.
//
// ---------------------------------------------------------------------------------------------------------------------------------
...
#if !defined(USE_MMGR)
#error USE_MMGR not defined in a project with mmgr.cpp!
#endif
