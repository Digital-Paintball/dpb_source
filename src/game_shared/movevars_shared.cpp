...
ConVar	sv_maxspeed		( "sv_maxspeed", "360", FCVAR_NOTIFY | FCVAR_REPLICATED);

ConVar	sv_maxarenaspeed( "sv_maxarenaspeed", "160", FCVAR_NOTIFY | FCVAR_REPLICATED);
#ifdef _XBOX
...
ConVar	sv_maxlean		( "sv_maxlean", "30", FCVAR_REPLICATED );
