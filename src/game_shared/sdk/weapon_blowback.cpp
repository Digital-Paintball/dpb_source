...
#include "paintballmgr.h"
	...
	#define CWeaponBlowback C_WeaponBlowback
...
// Weapon Blowback
//-----------------------------------------------------------------------------
class CWeaponBlowback : public CWeaponSDKBase
{
public:
	DECLARE_CLASS( CWeaponBlowback, CWeaponSDKBase );
	...
	virtual SDKWeaponID GetWeaponID( void ) const		{ return WEAPON_BLOWBACK; }


private:

	CWeaponBlowback( const CWeaponBlowback & );
...
IMPLEMENT_NETWORKCLASS_ALIASED( WeaponBlowback, DT_WeaponBlowback )

BEGIN_NETWORK_TABLE( CWeaponBlowback, DT_WeaponBlowback )
END_NETWORK_TABLE()

BEGIN_PREDICTION_DATA( CWeaponBlowback )
END_PREDICTION_DATA()

LINK_ENTITY_TO_CLASS( weapon_blowback, CWeaponBlowback );
PRECACHE_WEAPON_REGISTER( weapon_blowback );



CWeaponBlowback::CWeaponBlowback()
{
}

bool CWeaponBlowback::Deploy( )
{
...
void CWeaponBlowback::CheckReload( void )
{
...
void CWeaponBlowback::PrimaryAttack( void )
{
...
void CWeaponBlowback::WeaponIdle()
{
