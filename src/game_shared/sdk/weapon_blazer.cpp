...
#include "paintballmgr.h"
	...
	#define CWeaponBlazer C_WeaponBlazer
...
// Weapon Blazer
//-----------------------------------------------------------------------------
class CWeaponBlazer : public CWeaponSDKBase
{
public:
	DECLARE_CLASS( CWeaponBlazer, CWeaponSDKBase );
	...
	virtual SDKWeaponID GetWeaponID( void ) const		{ return WEAPON_BLAZER; }


private:

	CWeaponBlazer( const CWeaponBlazer & );
...
IMPLEMENT_NETWORKCLASS_ALIASED( WeaponBlazer, DT_WeaponBlazer )

BEGIN_NETWORK_TABLE( CWeaponBlazer, DT_WeaponBlazer )
END_NETWORK_TABLE()

BEGIN_PREDICTION_DATA( CWeaponBlazer )
END_PREDICTION_DATA()

LINK_ENTITY_TO_CLASS( weapon_blazer, CWeaponBlazer );
PRECACHE_WEAPON_REGISTER( weapon_blazer );



CWeaponBlazer::CWeaponBlazer()
{
}

bool CWeaponBlazer::Deploy( )
{
...
void CWeaponBlazer::CheckReload( void )
{
...
void CWeaponBlazer::PrimaryAttack( void )
{
