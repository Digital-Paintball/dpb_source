...
public:	// IMapOverview Interfaces
	...
	virtual bool CanPlayerBeTracked(int index);

	/// allows mods to restrict health
	/// Note: index is 0-based
	virtual bool CanPlayerHealthBeSeen(int index) { return true; }

	/// allows mods to restrict names (e.g. CS when mp_playerid is non-zero)
	/// Note: index is 0-based
	virtual bool CanPlayerNameBeSeen(int index) { return true; }
