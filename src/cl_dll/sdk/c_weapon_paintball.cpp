...
class C_Paintball : public C_BaseCombatCharacter
{
	DECLARE_CLASS( C_Paintball, C_BaseCombatCharacter );
	DECLARE_CLIENTCLASS();
public:
...
private:
	...
	C_Paintball( const C_Paintball & ); // not defined, not accessible

	Vector	m_vecLastOrigin;
	bool	m_bUpdated;
};

IMPLEMENT_CLIENTCLASS_DT( C_Paintball, DT_Paintball, CPaintball )
END_RECV_TABLE()

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
C_Paintball::C_Paintball( void )
{
}
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_Paintball::OnDataChanged( DataUpdateType_t updateType )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_Paintball::ClientThink( void )
{
	m_bUpdated = false;
}
